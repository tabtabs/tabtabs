...
{	
	/// <summary>
	/// The only purpose of this class is to test all the possible bindings for the MMTouchAxis, MMTouchJoystick and MMTouchButton classes
	/// </summary>
	public class NiceTouchTestInputManager : MonoBehaviour
	{
		...
		public virtual void DynamicJoystickMovement(Vector2 movement) { MMDebug.DebugOnScreen("dynamic joystick",movement); }
		...
		public virtual void Swipe(MMSwipeEvent swipeEvent)
		{
			MMDebug.DebugLogTime ("swipe detected. Direction : " + swipeEvent.SwipeDirection + ", angle : " + swipeEvent.SwipeAngle + ", length : " + swipeEvent.SwipeLength + ", origin : " + swipeEvent.SwipeOrigin + ", destination : " + swipeEvent.SwipeDestination);
		}
		public virtual void SwipeZonePressed()	{ MMDebug.DebugLogTime("Swipe zone pressed"); }
	}
}